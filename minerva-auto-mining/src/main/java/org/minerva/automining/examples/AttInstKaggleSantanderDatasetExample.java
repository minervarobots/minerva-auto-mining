...
public class AttInstKaggleSantanderDatasetExample {
    public static void main(String args[]) throws Exception{
    	
    	
        //load dataset
    	DataSource source = new DataSource("dataset/weka-dataset-arff/kaggle-santander-train.arff");
    	//DataSource source = new DataSource("dataset/weka-dataset-arff/credit-g.arff");

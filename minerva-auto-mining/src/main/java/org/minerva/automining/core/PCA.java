...
//    public void RunPCA(String[] args) throws Exception {

    public void RunPCA(String trainData) throws Exception {
...
//    	File file = new File("dataset/kaggle-weka-dataset/titanic/titanic_pca_train_dataset_output.txt");
...
//    	String write = "Hello World!";
 ...
 //   	FileWriter fw = new FileWriter(file);
   // 	BufferedWriter bw = new BufferedWriter(fw);
    ...
    //	fw.write(transformedIntoPCASpace);

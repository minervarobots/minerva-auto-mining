...
public class AutoWEKAClassifierTest {
	...
	public static void main(String[] args) throws Exception {
		...
		AutoWEKAClassifierTest runAutoWekaTest = new AutoWEKAClassifierTest();
		
		runAutoWekaTest.testDefaults();
    ...
    public void testDefaults() throws Exception {
        String[] args = {"-t", "dataset/kaggle-weka-dataset/titanic/train.arff", "-seed", "1", "-no-cv", "-timeLimit", "1"};
